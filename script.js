function calcola() {
	...
	function spiega() {
	 ...
	 if(s == "NMkm") {
		...
		spiega = 'Per eseguire la conversione da hPa a mmHg è necessario applicare la proporzione 760 mmHg : 1013,25 hPa = x [mmHg] : hPa [valore noto] . Dove 760 mmHg e 1013,25 hPa sono i valori della pressione dell atmosfera standard al livello del mare.'
	}
